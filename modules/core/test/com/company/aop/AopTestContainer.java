...
public class AopTestContainer extends TestContainer {

    public AopTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/aop/app.properties",
    ...
    public static class Common extends AopTestContainer {

        public static final AopTestContainer.Common INSTANCE = new AopTestContainer.Common();
